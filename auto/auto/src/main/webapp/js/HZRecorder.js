(function (window) {
    ...
    var Recorder = function (stream, config) {
        ...
        config.sampleRate = config.sampleRate || 44100;   //采样率16K
        //创建缓存，用来缓存声音
...
//                return wavd;
        ...
        this.trans = function (url, callback) {
            ...
            fd.set('wavData', this.getBlob());
            //console.log("wavData: " + buffer);
        ...
        //     document.getElementById('btn-text-content').value = "识别结果是：" +name;
        // };
